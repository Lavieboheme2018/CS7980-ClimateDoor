...
def get_incubator_recommendations_for_user(campaign_arn, user_id, num_results):
    """
...
def lambda_handler(event, context):
    try:
        ...
        # Replace with the specific campaign ARN for Incubators
        ...
        recommended_items = get_incubator_recommendations_for_user(campaign_arn, user_id, num_results)
