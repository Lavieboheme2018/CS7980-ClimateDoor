...
def get_grant_recommendations_for_user(campaign_arn, user_id, num_results):
    """
...
def lambda_handler(event, context):
    try:
        ...
        # Replace with the specific campaign ARN for Grants
        ...
        recommended_items = get_grant_recommendations_for_user(campaign_arn, user_id, num_results)
