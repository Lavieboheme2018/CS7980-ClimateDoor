...
TRACKING_ID = ""  # Add the tracking ID for Grant
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        try:
            ...
            response_code = put_grant_events(TRACKING_ID, user_id, "default-session", event_list)
...
def put_grant_events(tracking_id, user_id, session_id, event_list):
    """
