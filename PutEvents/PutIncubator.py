...
TRACKING_ID = ""  # Add the tracking ID for Incubator
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        try:
            ...
            response_code = put_incubator_events(TRACKING_ID, user_id, "default-session", event_list)
...
def put_incubator_events(tracking_id, user_id, session_id, event_list):
    """
